...
class Booking
{
    ...
    public function isBookableDates() {
       //1)Il faut coonaitre les dates qui sont impossibles pour l'annonce
     ...
     *
     * @return array Un tableau d'objets de DateTime représentant les jours de la réservation
     */
    public function getDays(){
      ...
      }, $resultat); //resultat si je le mets pas c'est la merde
