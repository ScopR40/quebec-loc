    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add(
               'title',
               TextType::class,
               $this->getConfiguration("Titre", "Rentrez un titre pour votre annonce")
            )
            ->add(
               'slug',
               TextType::class,
            ...
            ->add(
               'content',
               TextareaType::class,
               $this->getConfiguration("Description détaillée","Rentrez une descriptionqui donne vraiment envie de venir chez vous!")
            )
            ->add(
               'rooms',
               IntegerType::class,
