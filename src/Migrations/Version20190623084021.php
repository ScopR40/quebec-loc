 ...
 */
final class Version20190623084021 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE picture picture VARCHAR(255) NOT NULL, CHANGE hash hash VARCHAR(255) DEFAULT NULL');
    }
