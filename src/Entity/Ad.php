...
class Ad
{
    ...
    public function initializeSlug() {
        if(empty($this->slug)) { //si pas de slug
           ...
           $this->slug = $slugify->slugify($this->title); //title modifier grace a slugify en slug
        }
    }
    ...
    public function getNotAvailableDays() {
      ...
      foreach($this->bookings as $booking) {
         //Calculer les jours qui se trouve entre la date d'arrivée et la date de départ
         $resultat = range(
