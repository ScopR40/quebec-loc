...
class User implements UserInterface
{
    ...
    public function initializeSlug() {
      if(empty($this->slug)) { //si pas de slug
         $slugify = new Slugify(); //genere un slug
         $this->slug = $slugify->slugify($this->firstName . ' ' . $this->lastName); //slug fabriquer en fonction du firstname et du lastname
      }
  }
    ...
    public function getSalt() {} //pas besoin avec bcrypt

   public function getUsername() {
      return $this->email;
   }

   public function eraseCredentials() {} //pas besoin ici
}
